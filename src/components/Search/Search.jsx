    ...
    return (
        <div className='my-32 max-w-5xl mx-auto'>
            <div className='grid grid-col-1 md:grid-cols-3 gap-10'>
                ...
                <div className='absolute w-[300px] h-[200px] left-[240px] top-[200px] rounded-lg   bg-rose-100 hidden lg:block'></div>
                ...
                <div className='mx-auto text-center '>
                    ...
                    <div className='absolute top-[90px] right-[590px] hidden lg:block'>
